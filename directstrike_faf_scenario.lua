...
ScenarioInfo = {
    ...
    preview = '/maps/directstrike_faf.v0046/ds2.dds',
    map_version = 46,
    type = 'skirmish',
    starts = true,
    size = {512, 512},
    reclaim = {320916.6, 19.95},
    map = '/maps/directstrike_faf.v0046/directstrike_faf.scmap',
    save = '/maps/directstrike_faf.v0046/directstrike_faf_save.lua',
    script = '/maps/directstrike_faf.v0046/directstrike_faf_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
